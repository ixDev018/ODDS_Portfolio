...
class OddsSetting extends Model
{
    ...
    public static function current(): self
    {
        return static::firstOrCreate([], [
            ...
            'services_title' => "The odds are, we've already built something like it.",
            'services_desc' => "Software, apps, backend, games, hardware — chances are, whatever you're building, we've built its cousin before.",
