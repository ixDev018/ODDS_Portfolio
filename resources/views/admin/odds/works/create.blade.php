        ...
        <div class="pe-sidebar-scroll">
            ...
            <div class="space-y-1.5">
                ...
                <div id="video-dropzone" class="relative group aspect-[16/9] w-full rounded-xl border-2 border-dashed border-[#2b2b36] hover:border-[#875af5] bg-[#0d0d12] flex flex-col items-center justify-center p-3 text-center cursor-pointer transition-all overflow-hidden">
                    <div id="video-placeholder" class="flex flex-col items-center justify-center space-y-2 pointer-events-none">
                        <div class="w-10 h-10 rounded-full bg-[#181822] flex items-center justify-center text-[#875af5] group-hover:scale-110 transition-transform">
                    ...
                    <div id="video-preview-container" class="hidden absolute inset-0 w-full h-full bg-black">
                        <video id="video-preview-el" src="" class="w-full h-full object-cover" muted loop playsinline autoplay></video>
                        <div class="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                ...
                <div class="pt-1">
                    <input type="url" name="showcase_video_url" id="showcase_video_url" placeholder="Or paste Video URL (https://...mp4)" class="odds-input text-xs font-mono py-1 px-2.5">
                </div>
            </div>
