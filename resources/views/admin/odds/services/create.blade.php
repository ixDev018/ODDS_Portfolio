...
<form id="service-form" action="{{ route('odds.admin.services.store') }}" method="POST" enctype="multipart/form-data" class="pe-shell">
    @csrf
    ...
    <div class="pe-editor-col">
        <div class="pe-editor-header">
            <input type="text" name="name" required value="{{ old('name') }}" placeholder="Service Name (e.g. Software Development)..."
    ...
    <div class="pe-sidebar">
        ...
        <div class="pe-sidebar-scroll">
            <div>
                ...
                <input type="text" name="tagline" value="{{ old('tagline') }}" placeholder="e.g. Logic. Built to last." class="odds-input">
            </div>
            ...
            <div class="space-y-2">
                ...
                <div>
                    ...
                    <textarea name="icon_svg" id="icon_svg_input" rows="3" 
                              ...
                              class="odds-input font-mono text-[11px]">{{ old('icon_svg') }}</textarea>
                </div>
            </div>

            <!-- 16:9 Cover Image Uploader (Optional) -->
            ...
            <div>
                ...
                <input type="text" name="features" value="{{ old('features') }}" placeholder="e.g. Microservices, High Concurrency, Zero Downtime" class="odds-input text-xs">
            </div>

            <div class="grid grid-cols-2 gap-2">
                <div>
                    <label class="odds-label">CTA Button Text</label>
                    <input type="text" name="action_btn_text" value="{{ old('action_btn_text', "Let's Build") }}" placeholder="Let's Build" class="odds-input text-xs">
                </div>
                <div>
                    <label class="odds-label">CTA Target URL</label>
                    <input type="text" name="action_btn_url" value="{{ old('action_btn_url', '#cta') }}" placeholder="#cta" class="odds-input font-mono text-xs">
                </div>
            </div>
        ...
        <div class="pe-sidebar-footer flex items-center justify-between gap-2">
            ...
            <button type="submit" id="btn-submit-service" class="odds-btn-primary text-xs">
                <i class="fa-solid fa-cloud-arrow-up mr-1 text-[10px]"></i>
...
const initialBlocks = [
    ...
    { type: 'paragraph', content: 'Describe what this service solves, how your engineering team executes it, and why clients choose ODDS.' },
