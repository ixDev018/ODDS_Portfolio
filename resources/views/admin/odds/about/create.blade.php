...
<form id="about-form" action="{{ route('odds.admin.about.store') }}" method="POST" enctype="multipart/form-data" class="pe-shell">
    @csrf
    ...
    <div class="pe-editor-col">
        <div class="pe-editor-header">
            <input type="text" name="title" required value="{{ old('title') }}" placeholder="Untitled Section / Article..."
            ...
            <textarea name="subtitle" rows="2" placeholder="Write a short summary or introductory hook for this section..."
                      class="pe-desc-input">{{ old('subtitle') }}</textarea>
        </div>
    ...
    <div class="pe-sidebar">
        ...
        <div class="pe-sidebar-scroll">
            <div>
                ...
                <input type="text" name="category" value="{{ old('category', 'Our Philosophy') }}" placeholder="e.g. DNA, Vision, Team, Origin" class="odds-input">
            </div>

            <div class="grid grid-cols-2 gap-2">
                <div>
                    <label class="odds-label">Author</label>
                    <input type="text" name="author" value="{{ old('author', 'ODDS Core') }}" placeholder="ODDS Core" class="odds-input">
                </div>
                <div>
                    <label class="odds-label">Read Time</label>
                    <input type="text" name="read_time" value="{{ old('read_time', '3 min read') }}" placeholder="3 min read" class="odds-input font-mono text-xs">
                </div>
            </div>
...
const initialBlocks = [
    { type: 'heading2', content: 'Our Vision & DNA' },
    { type: 'paragraph', content: 'Describe how ODDS approaches software engineering, custom platforms, and rapid digital execution with stack-agnostic precision.' },
    { type: 'callout', content: 'Core Philosophy: Replace slow timelines and bloated frameworks with clean, flexible engineering that delivers.' },
    { type: 'heading3', content: 'What Sets Us Apart' },
    { type: 'bullet', content: 'Velocity-Driven Delivery — shipping stable, production-ready systems without unnecessary delays.' },
    { type: 'bullet', content: 'Deep Technical Versatility — architecting web, mobile, IoT, backend, and hardware systems seamlessly.' }
];
