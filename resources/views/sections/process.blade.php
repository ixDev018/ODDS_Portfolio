    ...
    <div class="process-content-wrap">
        ...
        <div class="process-linepath-wrap" aria-hidden="true">
            <svg class="process-linepath-svg" viewBox="0 0 565 925" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path id="process-line-path" class="process-line-path" d="M467.332 1.52271L460.779 65.742C454.431 127.953 404.689 176.83 342.376 182.085L114.38 201.314C89.7562 203.391 66.5806 213.818 48.6935 230.868C-13.312 289.973 14.502 394.256 97.7059 414.631L505.918 514.595C512.476 516.201 518.697 518.955 524.295 522.729C573.667 556.018 545.675 633.188 486.442 627.082L127.407 590.071C108.352 588.107 89.2368 593.184 73.668 604.345C11.7091 648.76 43.1302 746.523 119.364 746.523H150.72C201.364 746.523 241.681 788.937 239.117 839.515L234.832 924.023" stroke="#FF7E5D" stroke-width="30"/>
            </svg>
        </div>
