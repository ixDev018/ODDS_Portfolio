...
@php
    if (!isset($settings)) {
        $settings = \App\Models\OddsSetting::current();
    }
@endphp
    ...
    <div class="footer-main-container">
        <div class="footer-grid-layout">
            ...
            <div>
                ...
                <p class="text-xs leading-relaxed text-slate-300 max-w-sm mb-4">
            ...
            {{-- Column 4: Direct Line & Connect (Placed on the 4th cell on the right side) --}}
            <div class="footer-col-direct-line">
                <div class="footer-col-title">
                ...
                <div class="footer-social-row">
                    <a href="{{ !empty($settings->cta_facebook) ? (str_starts_with($settings->cta_facebook, 'http') ? $settings->cta_facebook : 'https://facebook.com/' . $settings->cta_facebook) : 'https://facebook.com' }}" target="_blank" rel="noopener" class="footer-social-btn" aria-label="Facebook">
                        <i class="fa-brands fa-facebook-f"></i>
                    </a>
                    <a href="{{ !empty($settings->cta_instagram) ? (str_starts_with($settings->cta_instagram, 'http') ? $settings->cta_instagram : 'https://instagram.com/' . $settings->cta_instagram) : 'https://instagram.com' }}" target="_blank" rel="noopener" class="footer-social-btn" aria-label="Instagram">
                        <i class="fa-brands fa-instagram"></i>
                    </a>
                    <a href="{{ !empty($settings->cta_youtube) ? (str_starts_with($settings->cta_youtube, 'http') ? $settings->cta_youtube : 'https://youtube.com/' . $settings->cta_youtube) : 'https://youtube.com' }}" target="_blank" rel="noopener" class="footer-social-btn" aria-label="YouTube">
        ...
        <div class="footer-bottom-bar">
            ...
            <!-- <div class="font-mono text-xs text-slate-500">
                Stack-Agnostic Precision Standard // {{ date('Y') }}
            </div>
