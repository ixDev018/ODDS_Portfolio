...
<div id="project-modal" class="project-modal-backdrop select-none hidden" aria-hidden="true" role="dialog" aria-modal="true">
  ...
  <div class="frame46-container project-modal-card">
    ...
    <!-- Sticky Floating Header Capsule (White Pill) -->
    <div class="frame46-header">
      <div class="frame46-breadcrumb">
        
        <!-- Left: Violet Action / Return / Close Button -->
        <button type="button" id="project-modal-close-btn" class="frame46-back-btn" aria-label="Close project details">
        ...
        <!-- ODDS Official Brand Logo -->
        <div class="frame46-inner-logo">
          <svg width="68" height="22" viewBox="0 0 88 28" fill="none" xmlns="http://www.w3.org/2000/svg" style="height: 18px; width: auto;" class="text-[#111827]">
        ...
        <!-- Vertical Divider -->
        <div class="frame46-divider"></div>

        <!-- Recessed Search/Path Pill -->
        <div class="frame46-path-pill">
          <span id="project-modal-path" class="frame46-path-text font-mono">
            ODDS_Project/Theodore/Project_Story
          </span>
        </div>

        <!-- Right: Action / Live Demo Pill Container -->
        <div id="project-modal-links" class="flex items-center space-x-2">
          <!-- Populated dynamically via JS when demo / repo links exist -->
        </div>
    ...
    <div class="frame46-body">

      <!-- Section 1: Main Project Overview Block -->
      <div class="frame46-section">
        
        <!-- Clean Title (No Box Padding/Fill) -->
        <div class="frame46-title-wrap">
          <h1 id="project-modal-title" class="frame46-title-text">
            PROJECT TITLE
          </h1>
        </div>

        <!-- Clean Subtitle / Metadata Row (No Box Padding/Fill) -->
        <div class="frame46-subtitle-wrap">
          <span id="project-modal-category" class="frame46-meta-category">Architecture</span>
          <span class="frame46-meta-dot">•</span>
          <span id="project-modal-year" class="frame46-meta-year">2024</span>
          <span id="project-modal-client-wrap" class="hidden"><span class="frame46-meta-dot">•</span><span id="project-modal-client" class="text-xs text-gray-300 font-mono"></span></span>
          <span id="project-modal-role-wrap" class="hidden"><span class="frame46-meta-dot">•</span><span id="project-modal-role" class="text-xs text-gray-300 font-mono"></span></span>
        </div>

        <!-- Body Text Overview Lines -->
        <div class="frame46-lines">
          <p id="project-modal-desc" class="frame46-desc-text">
            Short project overview hook and high-level architectural summary...
          </p>
        </div>

        <!-- Primary Full-Width Media Container -->
        <div id="project-modal-primary-media" class="frame46-media-box">
          <!-- Populated dynamically if cover / preview is present -->
        </div>

      </div>

      <!-- Dynamic Notion Blocks Container (Section 2 & Stories) -->
      <div id="project-modal-blocks" class="frame46-dynamic-blocks">
        <!-- Rendered via JS -->
      </div>
